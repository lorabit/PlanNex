...
(function() {
    ...
    (function(a) {
        I.HighchartsAdapter = I.HighchartsAdapter || a && {
            init: function(b) {
                ...
                X(a.cssHooks.opacity, "get", function(a, b, c) {
    ...
    H.prototype = {
        ...
        css: function(a) {
            ...
            if (e) {
                e = this.textWidth = a && a.width && d.nodeName.toLowerCase() === "text" && B(a.width);
                b && (a = q(b, c));
                this.styles = a;
        ...
        align: function(a, b, c) {
            ...
            f = e.alignedObjects;
            if (a) {
                if (this.alignOptions = a, this.alignByTranslate = b, !c || Ca(c)) this.alignTo = d = c || "renderer", ta(f, this), f.push(this), c = null
        ...
        getBBox: function() {
            ...
            if (!a) {
                ...
                if (b.isSVG) {
                    ...
                    if (e) a.width = U(d * va(g)) + U(c * qa(g)), a.height = U(d * qa(g)) + U(c * va(g))
                }
                this.bBox = a;
                h && (b.cache[h] = a)
            }
    ...
    H.prototype.translateXSetter = H.prototype.translateYSetter = H.prototype.rotationSetter = H.prototype.verticalAlignSetter = H.prototype.scaleXSetter = H.prototype.scaleYSetter = function(a, b) {
        this[b] = a;
        this.doTransform = !0
    };
    ...
    ba.prototype = {
        ...
        init: function(a, b, c, d, e) {
            ...
            this.boxWrapper = d;
            this.alignedObjects = [];
            this.url = (Ma || ib) && y.getElementsByTagName("base").length ? f.href.replace(/#.*?$/, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
        ...
        buildText: function(a) {
            for (var b = a.element, c = this, d = c.forExport, e = p(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, j = G(b, "x"), k = a.styles, l = a.textWidth, n = k && k.lineHeight, m = k && k.HcTextStroke, x = g.length, M = function(a) {
                return n ? B(n) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : k && k.fontSize || c.style.fontSize || 12, a).h
            }; x--;) b.removeChild(g[x]);
            !f && !m && e.indexOf(" ") === -1 ? b.appendChild(y.createTextNode(e)) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, l && !a.added && this.box.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), o(e, function(e, f) {
                var g, n = 0,
                ...
                o(g, function(e) {
                    if (e !== "" || g.length === 1) {
                        ...
                        i.test(e) && !d && (G(x, "onclick", 'location.href="' + e.match(i)[1] + '"'), D(x, {
                            cursor: "pointer"
                        }));
                        ...
                        if (e !== " ") {
                            ...
                            if (l) for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), m = g.length > 1 || e.length > 1 && k.whiteSpace !== "nowrap", o, z, r = k.HcHeight, q = [], t = M(x), Db = 1; m && (e.length || q.length);) delete a.bBox, o = a.getBBox(), z = o.width, !ca && c.forExport && (z = c.measureSpanWidth(x.firstChild.data, a.styles)), o = z > l, !o || e.length === 1 ? (e = q, q = [], e.length && (Db++, r && Db * t > r ? (e = ["..."], a.attr("title", a.textStr)) : (x = y.createElementNS(xa, "tspan"), G(x, {
                                dy: t,
                                x: j
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            function j() {
                ...
                if (mb) {
                    if (!p) a = w(-O * E), b = h ? -Ba : 0, m.box = p = d ? n.symbol(d, a, b, m.width, m.height, A) : n.rect(a, b, m.width, m.height, 0, A[Jb]), p.attr("fill", S).add(m);
                    p.isImg || p.attr(q({
                        width: w(m.width),
                        height: w(m.height)
                    }, A));
    ...
    if (!ca && !ga) L = {
        ...
        pathToVML: function(a) {
            for (var b = a.length, c = []; b--;) if (ka(a[b])) c[b] = w(a[b] * 10) - 5;
            else if (a[b] === "Z") c[b] = "x";
    ...
    }, K.VMLElement = L = da(H, L), L.prototype.ySetter = L.prototype.widthSetter = L.prototype.heightSetter = L.prototype.xSetter, L = {
        Element: L,
        ...
        color: function(a, b, c, d) {
            ...
            if (i) {
                ...
                if (c === "fill") if (i === "gradient") c = n.x1 || n[0] || 0, a = n.y1 || n[1] || 0, m = n.x2 || n[2] || 0, n = n.y2 || n[3] || 0, E = 'angle="' + (90 - F.atan((n - a) / (m - c)) * 180 / hb) + '"', s();
                else {
                    var j = n.r,
                        t = j * 2,
                        w = j * 2,
                        ...
                        v = b.radialReference,
                        y, j = function() {
                            v && (y = d.getBBox(), u += (v[0] - y.x) / y.width - 0.5, A += (v[1] - y.y) / y.height - 0.5, t *= v[2] / y.width, w *= v[2] / y.height);
    ...
    }, L.prototype.symbols = {}, Eb = function() {
        function a() {
            var a = b.length,
                d;
            for (d = 0; d < a; d++) b[d]();
    ...
    La.prototype = {
        ...
        handleOverflow: function(a, b) {
            ...
            if (m) {
                ...
                while (i[a] && (!m || !m.label || m.label.line !== p));
    ...
    Q.prototype = {
        ...
        init: function(a, b) {
            ...
            this.crosshair = p(d.crosshair, na(a.options.tooltip.crosshairs)[c ? 0 : 1], !1);
        ...
        setOptions: function(a) {
            this.options = v(this.defaultOptions, this.isXAxis ? {} : this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], v(J[this.coll], a))
        },
        defaultLabelFormatter: function() {
            ...
            else if (f && a >= 1E3) for (; f-- && g === r;) c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = oa(b / c, -1) + e[f]);
            ...
            o(a.series, function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        ...
                        e = c.dataMax;
                        c = c.dataMin;
                        if (t(c) && t(e)) a.dataMin = R(p(a.dataMin, c), c), a.dataMax = s(p(a.dataMax, e), e);
        ...
        adjustForMinRange: function() {
            var a = this.options,
                ...
                f, g, h, i, j;
            if (this.isXAxis && this.minRange === r && !this.isLog) t(a.min) || t(a.max) ? this.minRange = null : (o(this.series, function(a) {
                i = a.xData;
        ...
        setTickPositions: function(a) {
            var b = this,
                ...
                z, O = b.categories;
            j ? (b.linkedParent = c[b.coll][d.linkedTo], c = b.linkedParent.getExtremes(), b.min = p(c.min, c.dataMin), b.max = p(c.max, c.dataMax), d.type !== b.linkedParent.options.type && ja(11, 1)) : (b.min = p(b.userMin, d.min, b.dataMin), b.max = p(b.userMax, d.max, b.dataMax));
            ...
            if (!O && !b.axisPointRange && !b.usePercentage && !j && t(b.min) && t(b.max) && (c = b.max - b.min)) {
                ...
                if (!t(d.max) && !t(b.userMax) && l && (b.dataMax > 0 || !b.ignoreMaxPadding)) b.max += c * l
            }
            ...
            if (!j) d = a[0], g = a[a.length - 1], h = b.minPointOffset || 0, e ? b.min = d : b.min - h > d && a.shift(), f ? b.max = g : b.max + h < g && a.pop(), a.length === 0 && t(d) && a.push((g + d) / 2), a.length === 1 && (e = U(b.max) > 1E13 ? 1 : 0.001, b.min -= e, b.max += e)
        },
        ...
        getOffset: function() {
            ...
            if (x && x.text && x.enabled !== !1) {
                ...
                if (k) l = a.axisTitle.getBBox()[g ? "height" : "width"], n = x.offset, m = t(n) ? 0 : p(x.margin, g ? 5 : 10);
        ...
        drawCrosshair: function(a, b) {
            if (this.crosshair) if ((t(b) || !p(this.crosshair.snap, !0)) === !1) this.hideCrosshair();
            else {
                var c, d = this.crosshair,
                    e = d.animation;
                p(d.snap, !0) ? t(b) && (c = this.chart.inverted != this.horiz ? b.plotX : this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos;
    ...
    Q.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        else if (a >= 0.08) for (var f = ea(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
            i = e.length;
    ...
    ya.prototype = {
        ...
        inClass: function(a, b) {
            for (var c; a;) {
                if (c = G(a, "class")) if (c.indexOf(b) !== -1) return !0;
    ...
    Xa.prototype = {
        init: function(a, b) {
            var c = this,
                ...
                f = b.itemMarginTop || 0;
            this.options = b;
            if (b.enabled) c.itemStyle = d, c.itemHiddenStyle = v(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.symbolWidth = p(b.symbolWidth, 16), c.pages = [], c.render(), N(c.chart, "endResize", function() {
    ...
    pa.prototype = {
        ...
        initSeries: function(a) {
            ...
            (b = u[a.type || b.type || b.defaultSeriesType]) || ja(17, !0);
            b = new b;
            b.init(this, a);
            return b
        },
    ...
    T.prototype = {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData) o(a, function(a, b) {
                ...
                if (x && h > x) {
                    ...
                    if (ka(k)) {
                        ...
                        for (c = 0; c < h; c++) q[c] = n, z[c] = a[c], n += i;
                        e.xIncrement = n
                    } else if (Da(k)) if (s) for (c = 0; c < h; c++) i = a[c], q[c] = i[0], z[c] = i.slice(1, s + 1);
                    else for (c = 0; c < h; c++) i = a[c], q[c] = i[0], z[c] = i[1];
                    else ja(12)
        ...
        processData: function(a) {
            ...
            for (i = b.length - 1; i >= 0; i--) d = b[i] - b[i - 1], !f && b[i] > m && b[i] < n && k++, d > 0 && (g === r || d < g) ? g = d : d < 0 && this.requireSorting && ja(15);
            this.cropped = f;
            this.cropStart = e;
        ...
        drawPoints: function() {
            ...
            if (l.enabled !== !1 || this._hasPointMarkers) for (f = b.length; f--;) if (g = b[f], d = ea(g.plotX), e = g.plotY, k = g.graphic, m = g.marker || {}, o = !! g.marker, a = t && m.enabled === r || m.enabled, s = c.isInsidePlot(w(d), e, c.inverted), a && e !== r && !isNaN(e) && g.y !== null) if (a = g.pointAttr[g.selected ? "select" : ""] || n, h = a.r, i = p(m.symbol, this.symbol), j = i.indexOf("url") === 0, k) k[s ? "show" : "hide"](!0).animate(q({
                x: d - h,
                y: e - h
            }, k.symbolName ? {
                width: 2 * h,
        ...
        getAttribs: function() {
            ...
            i = b.turboThreshold;
            var r;
            b.marker ? (e.radius = e.radius || c.radius + e.radiusPlus, e.lineWidth = e.lineWidth || c.lineWidth + e.lineWidthPlus) : e.color = e.color || Z(e.color || g).brighten(e.brightness).get();
            ...
            if (!i || g < i || k) for (; g--;) {
                ...
                if (k) {
                    ...
                    d = c.states || {};
                    f = d.hover = d.hover || {};
                    if (!b.marker) f.color = f.color || !i.options.color && e.color || Z(i.color).brighten(f.brightness || e.brightness).get();
                    f = {
                        color: i.color
                    };
    ...
    T.prototype.drawDataLabels = function() {
        ...
        if (d.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(d), j = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), p(d.defer, !0) && (j.attr({
            ...
            if (h && !e) b.dataLabel = h.destroy();
                ...
                e = d.rotation;
                m = b.getLabelConfig();
                i = d.format ? Ia(d.format, m) : d.formatter.call(m, d);
                ...
                h && a.alignDataLabel(b, h, d, null, w)
            }
        })
    };
    ...
    if (u.pie) u.pie.prototype.drawDataLabels = function() {
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                if (L) {
                    ...
                    if (n > 0) {
                        ...
                        for (A = 0; A < L; A++) {
                            ...
                            c = 9999;
                            var S, Q;
                            for (Q = 0; Q < v; Q++) S = U(I[Q] - y[1]), S < c && (c = S, H = Q);
                            if (H < A && I[A] !== null) H = A;
                            else for (v < L - A + H && I[A] !== null && (H = v - L + A); I[H] === null;) H++;
                            P.push({
                                i: H,
                                y: I[H]
                            });
            ...
            if (Fa(F) === 0 || this.verifyDataLabelOverflow(F)) this.placeDataLabels(), t && g && o(this.points, function(b) {
                j = b.connector;
                y = b.labelPos;
                if ((u = b.dataLabel) && u._pos) K = u._attr.visibility, D = u.connX, C = u.connY, k = l ? ["M", D + (y[6] === "left" ? 5 : -5), C, "C", D, C, 2 * y[2] - y[4], 2 * y[3] - y[5], y[2], y[3], "L", y[4], y[5]] : ["M", D + (y[6] === "left" ? 5 : -5), C, "L", y[2], y[3], "L", y[4], y[5]], j ? (j.animate({
                    d: k
    ...
    }, u.pie.prototype.alignDataLabel = aa, u.pie.prototype.verifyDataLabelOverflow = function(a) {
        var b = this.center,
            c = this.options,
            d = c.center,
            e = c = c.minSize || 80,
    ...
    X(Q.prototype, "setAxisTranslation", function(a) {
        var b = this.chart,
            ...
            d = b.xAxis[0];
        a.call(this);
        if (b.options.chart.preserveAspectRatio && this.coll === "yAxis" && d.transA !== r && (this.transA = d.transA = Math.min(this.transA, d.transA), a = c / ((d.max - d.min) / (this.max - this.min)), d = a < 1 ? this : d, a = (d.max - d.min) * d.transA, d.pixelPadding = d.len - a, d.minPixelPadding = d.pixelPadding / 2, a = d.fixTo)) {
    ...
    q(Za.prototype, {
        ...
        init: function(a, b) {
            ...
            Q.prototype.init.call(this, a, d);
    ...
    q(pa.prototype, {
        renderMapNavigation: function() {
            ...
            if (p(b.enableButtons, b.enabled) && !a.renderer.forExport) for (d in c) if (c.hasOwnProperty(d)) f = v(b.buttonOptions, c[d]), e = f.theme, g = e.states, e = a.renderer.button(f.text, 0, 0, h, e, g && g.hover, g && g.select, 0, d === "zoomIn" ? "topbutton" : "bottombutton").attr({
                width: f.width,
                height: f.height,
    ...
    X(pa.prototype, "showCredits", function(a, b) {
        if (J.credits.text === this.options.credits.text && this.mapCredits) b.text = this.mapCredits, b.href = null;
        a.call(this, b)
    });
    q(J.lang, {
        zoomIn: "Zoom in",
        ...
        setTooltipPoints: function(a) {
            ...
            if (!(this.options.enableMouseTracking === !1 || this.singularTooltips)) {
                ...
                for (i = 0; i < a; i++) if (e = b[i], c = e.x, c >= f.min && c <= f.max) {
                    h = b[i + 1];
                    c = d === r ? 0 : d + 1;
                    for (d = b[i + 1] ? R(s(0, ea((e.clientX + (h ? h.wrappedClientX || h.clientX : g)) / 2)), g) : g; c >= 0 && c <= d;) j[c++] = e
                }
